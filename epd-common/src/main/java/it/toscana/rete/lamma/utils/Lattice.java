...
public class Lattice {
    ...
    public class LatticeValues {
        ...
        public boolean isValid() {
            if(this.isValueValid(this.c000) && this.isValueValid(this.c100) && this.isValueValid(this.c010) && this.isValueValid(this.c110) &&
                this.isValueValid(this.c001) && this.isValueValid(this.c101) && this.isValueValid(this.c011) && this.isValueValid(this.c111)) {
                    return true;
            }
            return false;
        }
    ...
    // Extract the data from the grid (todo: consider if it has or not height dimension)
    public LatticeValues getLatticeValue(GridDatatype param) throws IOException {
            ...
            LatticeValues values =  new LatticeValues(c000, c100, c010, c110, c001, c101, c011, c111);
            if(!values.isValid()) {
                throw new IOException("Value not valid");
            }
            return values;
