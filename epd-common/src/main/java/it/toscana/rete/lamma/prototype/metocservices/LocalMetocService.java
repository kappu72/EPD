...
public class LocalMetocService extends MapHandlerChild {
    ...
    // private LammaGrib metoc;
    private PntHandler pntHandler;

    private static final Logger LOG = LoggerFactory.getLogger(LocalMetocService.class);
    private GridDataset metocDataset;

    public LocalMetocService() {
        ...
        Set<Enhance> EnhanceAll = Collections
                .unmodifiableSet(EnumSet.of(Enhance.ScaleMissing, Enhance.CoordSystems, Enhance.ConvertEnums));
        NetcdfDataset.setDefaultEnhanceMode(EnhanceAll);
    }
